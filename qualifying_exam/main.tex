...
\hspace{1em}Female & 1130 (80.9\%)\\
\hspace{1em}Male & 267 (19.1\%)\\
\addlinespace[0.3em]
\multicolumn{2}{l}{\textbf{age}}\\
\hspace{1em}Mean (SD) & 38.4 (9.79)\\
\hspace{1em}Median [Min, Max] & 37.4 [18.0, 59.8]\\
\addlinespace[0.3em]
\multicolumn{2}{l}{\textbf{etnia}}\\
\hspace{1em}Asian & 48 (3.4\%)\\
\hspace{1em}Black & 331 (23.7\%)\\
\hspace{1em}Other/Not informed & 13 (0.9\%)\\
\hspace{1em}White & 1005 (71.9\%)\\
\addlinespace[0.3em]
\multicolumn{2}{l}{\textbf{estado\_civil}}\\
\hspace{1em}Mean (SD) & 2.37 (1.23)\\
\hspace{1em}Median [Min, Max] & 3.00 [1.00, 5.00]\\
\addlinespace[0.3em]
\multicolumn{2}{l}{\textbf{escolaridade}}\\
\hspace{1em}Primary School & 17 (1.2\%)\\
\hspace{1em}Secondary School & 295 (21.1\%)\\
\hspace{1em}University degree or higher & 1085 (77.7\%)\\
\addlinespace[0.3em]
\multicolumn{2}{l}{\textbf{renda}}\\
\hspace{1em}Mean (SD) & 9200 (7950)\\
\hspace{1em}Median [Min, Max] & 6000 [600, 40000]\\
\hspace{1em}Missing & 243 (17.4\%)\\
\addlinespace[0.3em]
\multicolumn{2}{l}{\textbf{ocupacao}}\\
...
\addlinespace[0.3em]
\multicolumn{2}{l}{\textbf{grupo}}\\
\hspace{1em}Good sleeper & 335 (24.0\%)\\
\hspace{1em}Insomnia & 1062 (76.0\%)\\
\addlinespace[0.3em]
\multicolumn{2}{l}{\textbf{region}}\\
\hspace{1em}Central-West & 54 (3.9\%)\\
\hspace{1em}Northeast & 105 (7.5\%)\\
\hspace{1em}Northern & 36 (2.6\%)\\
\hspace{1em}Southeast & 1083 (77.5\%)\\
\hspace{1em}Southern & 112 (8.0\%)\\
\hspace{1em}Missing & 7 (0.5\%)\\
\bottomrule
\end{tabular}
