...
This study was approved by the Ethics Committee of the General Hospital of the University of São Paulo, School of Medicine (HCFMUSP), São Paulo, Brazil (CAAE: 46284821.1.0000.0068). Inclusion criteria was age between 18 and 59 years and reporting no difficulties in reading or writing in Portuguese. Participants were informed about the main objective of the research and signed the informed consent. Then, they were requested to respond to an online survey using REDCap electronic data capture tools (Harris et al., 2009, 2019), including the Brazilian-Portuguese versions of DBAS-16 and SPAQ and other auxiliary instruments.
...
Next, we examine item response patterns using Mokken Scaling Analysis (MSA), a non-parametric Item Response Theory thecnique. Explain what MSA is about.
