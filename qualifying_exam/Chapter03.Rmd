...
```{r flowcca2, echo=FALSE, fig.align='center', fig.cap='Stages of cross-cultural adaptation. Adapted from “Cross-Cultural Adaptation and Validation of Psychological Instruments: Some Considerations”', message=FALSE,  fig.align = 'center', out.width="100%", fig.width=9}
