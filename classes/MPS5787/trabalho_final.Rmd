---
title: "Terapia cognitivo-comportamental para insônia e depressão para pacientes com ambos diagnósticos: Um ensaio clínico randomizado"
...
Pouco se sabe sobre o efeito da adição de um componente para insônia na TCC convencional para depressão no tratamento de pacientes com comorbidade de ambos os transtornos.
---
name: objetivos
...
- O estudo será realizado como um **ensaio clínico randomizado-controlado paralelo**. Os participantes que atenderem aos critérios de inclusão serão randomizados entre grupos TTC para depressão (TCC-D), TCC para depressão e insônia (TCC-D-I).
...
- Os desfechos primários e secundários serão avaliados por meio de escalas padronizadas de auto-relato:
...
.bigger-text[
Os desfechos primário e secundário serão analisados comparando os escores dos grupos em relação às medidas de avaliação.

O modelo inclui as variáveis **Grupo** (TCC-I e TCC-DI) e **Tempo** (pré-tratamento, pós-tratamento e seguimento).
]
