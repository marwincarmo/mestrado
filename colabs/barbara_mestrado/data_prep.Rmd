...
dat <- raw.data |>
  ...
  dplyr::select(record_id, nome, cpf, redcap_event_name, sexo, etnia, estado_civil, filhos_numero, escolaridade, ocupacao, dplyr::starts_with("igi_"), dplyr::starts_with("ehad_"), ds_horario_deitar:ds_medicacao) |> 
