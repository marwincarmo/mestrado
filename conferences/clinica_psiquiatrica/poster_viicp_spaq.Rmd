...
plot(NetworkSPAQ, layout = "spring",
     ...
     legend.mode="style2",
     vsize = 10,details = F,legend = FALSE)
...
```{r fig2, echo=FALSE, fig.cap='Decomposing dysfunctional beliefs about sleep by psychological inflexibility interaction via simple slopes for psychological inflexibility.', fig.height=6, out.width="100%", dpi=300}
library("qgraph")
...
In this analysis we found that three items of SPAQ were particularly strong on the estimated network, namely those concerning controlling /fighting sleep problems. This may provide valuable insights to guide third-wave therapies for insomnia.
