...
logoleft_name: img/fapesp2.png
logoright_name: img/ipq_2.png
logocenter_name: img/qr_imglg.png
output: 
...
cap <- 'Table 2: A modelsummary table customized with kableExtra'
...
tab %>% 
  ...
  set_background_color(row = 1, col = everywhere, "grey95") %>% 
  set_width(1)
