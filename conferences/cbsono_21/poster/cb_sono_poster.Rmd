...
logocenter_name: img/qrcode.png
output: 
...
This poster was created using `posterdown` package [@R-posterdown]. Full reproducible code available at https://bit.ly/postercbs
</span>
